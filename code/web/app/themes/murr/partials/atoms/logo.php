...
<a aria-label="<?= esc_attr(get_bloginfo('name')) . $ariaLabel ?>" href="<?= get_home_url(); ?>" rel="home" class="<?= implode(' ', $className) ?>" id="<?= esc_attr($id) ?>">
    <svg id="mk" xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" viewBox="0 0 416.2 187.2">
        <polygon points="0 0 0 187.2 32.2 187.2 32.2 178.6 10 178.6 10 8.6 32.2 8.6 32.2 0 0 0 0 0" fill="var(--mk-brand)" />
        ...
        <polygon points="384 0 384 8.6 406.2 8.6 406.2 178.6 384 178.6 384 187.2 416.2 187.2 416.2 0 384 0" fill="var(--mk-brand)" />
    </svg>
</a>
